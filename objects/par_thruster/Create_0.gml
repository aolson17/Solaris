...
thrust_left = 0
thrust_right = 0
// Set up real thrust values after creation for things like image_angle to be updated
alarm[0] = 1


active = 0 // How much this thruster is being used, from 0 to 1 where 1 is being fully used


// Change these in each thruster object
part_scale = 1 // How big of a thruster effect
part_region_distance = 40 // How far away from the origin to create the particles
