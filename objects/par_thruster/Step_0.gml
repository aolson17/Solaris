...
if active != 0{
	...
	var xp, yp;
	xp = surface_get_width(part_surf)/2//x+lengthdir_x(40,image_angle+90);
	yp = surface_get_height(part_surf)/2//y+lengthdir_y(40,image_angle+90);
	...
	part_emitter_stream(ps_thruster, pe_Effect1, pt_Effect1, 6*active);
